...
const MainFlexColcenter = styled.div``

const Delete = () => {
  return (
    <FlexColcenter className="flex flex-col items-center justify-center min-h-screen py-2">
      <Head>
        <title>Create Next App</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <MainFlexColcenter className="flex flex-col items-center justify-center flex-1 w-full px-20 text-center">
